...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2018 at 04:02 PM
...
--
-- Database: `tienda_base_development`
--
...
('environment', 'development', '2018-06-01 01:23:03', '2018-06-01 01:23:03');
...
(3, 'Winston', 'Stand', '12345', 1, '3', 'erddf', '080001', '3244', 1, 1, 1, 1, 0, '2018-06-01 01:42:02', '2018-06-01 01:42:02'),
(4, 'Winston', 'Stand', '32432432', 41, '3242', 'fanita111@hotmail.com', '080001', '34234', 38, NULL, NULL, NULL, 0, '2018-06-02 16:05:13', '2018-06-02 16:05:13'),
(5, 'Evelin', 'Silva Hurtado', '12334566', 41, 'No tiene', 'evelinsilvahurtado9@gmail.com', 'Carrera 1sur # 48 - 09', '1223', 38, NULL, NULL, NULL, 0, '2018-06-04 01:58:50', '2018-06-04 01:58:50'),
(6, 'Fanny Esther', 'Stand Sanchez', '32606931', 31, 'independiente', 'fanita111@hotmail.com', 'carrera 18 # 45 e 09', '3126404767', 33, 37, NULL, 41, 0, '2018-06-04 02:51:41', '2018-06-04 02:51:41');
...
(11, NULL, 'Registro Usuario', NULL, 'A', NULL, 1, 'user', 0);
...
(12, 'idcategoriacliente', 'Categoría Cliente', 'A', 0, '2018-05-15 17:55:11', '2018-05-15 17:55:11'),
...
--
-- Table structure for table `role_option_operations`
--
...
--
-- Dumping data for table `role_option_operations`
--
...
(1, 'hpajaro', '81dc9bdb52d04dc20036dbd8313ed055', 1, 36, 24, 26, 0, '2018-05-15 18:36:15', '2018-06-04 01:52:18'),
...
--
-- Table structure for table `valorparametros`
--
...
--
-- Dumping data for table `valorparametros`
--
...
(1, 'Prueba', 'A', NULL, 0, 16, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
...
(56, 'CC', 'A', NULL, 0, 4, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(57, 'TI', 'A', NULL, 0, 4, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
(58, 'PASAPORTE', 'A', NULL, 0, 4, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL);
...
--
-- Indexes for table `role_option_operations`
--
...
--
-- Indexes for table `valorparametros`
--
...
--
-- AUTO_INCREMENT for table `detfacturas`
--
ALTER TABLE `detfacturas`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `role_option_operations`
--
ALTER TABLE `role_option_operations`
...
--
-- AUTO_INCREMENT for table `valorparametros`
--
ALTER TABLE `valorparametros`
...
--
-- Constraints for table `role_option_operations`
--
ALTER TABLE `role_option_operations`
  ADD CONSTRAINT `fk_rails_825ca42662` FOREIGN KEY (`options_id`) REFERENCES `options` (`id`);

--
-- Constraints for table `valorparametros`
--
ALTER TABLE `valorparametros`
